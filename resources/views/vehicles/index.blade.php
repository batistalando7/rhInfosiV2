            ...
            <div class="card-header bg-secondary text-white d-flex justify-content-between align-items-center">
                ...
                <div>
                    <a href="{{ route('vehicles.pdfAll', request()->only('startDate', 'endDate')) }}"
                        ...
                        Baixar PDF
                        ({{ request()->filled('startDate') || request()->filled('endDate') ? 'Filtrado' : 'Todos' }})
                    </a>
                    <a href="{{ route('vehicles.create') }}" class="btn btn-outline-light btn-sm"
                        title="Adicionar Nova Viatura">
                    ...
                    <tbody>
                        @foreach ($vehicles as $v)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('vehicles.show', $v->id) }}" class="btn btn-warning btn-sm"><i
                                            class="fas fa-eye"></i></a>
                                    <a href="{{ route('vehicles.edit', $v->id) }}" class="btn btn-info btn-sm"><i
