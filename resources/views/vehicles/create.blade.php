                ...
                <div class="row g-3">
                    <div class="col-md-3">
                        <div class="form-floating">
                            <input type="text" name="plate" id="plate" class="form-control" placeholder=""
                                maxlength="12" value="{{ old('plate') }}">
                    ...
                    <div class="col-md-3">
                        <div class="form-floating">
                            <input type="number" name="yearManufacture" id="yearManufacture" class="form-control"
                                placeholder="" value="{{ old('yearManufacture') }}">
