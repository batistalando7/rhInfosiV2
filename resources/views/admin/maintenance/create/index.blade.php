        ...
        <div class="card-body">
            <form action="{{ route('admin.maintenances.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-md-12">
                        <div class="form-floating">
                            <select name="vehicleId" id="vehicleId" class="form-select" required
                                onchange="loadVehicleDetails(this.value)">
                                <option value="">Selecione a Viatura</option>
                                @foreach ($vehicles as $v)
                                    <option value="{{ $v->id }}" data-brand="{{ $v->brand }}"
                                        data-model="{{ $v->model }}" data-year="{{ $v->yearManufacture }}"
                                        data-plate="{{ $v->plate }}">
                    ...
                    <div class="col-md-12">
                        <div class="form-floating">
                            <select name="type" id="type" class="form-select" required
                                onchange="toggleSubtypes(this.value)">
                    ...
                    <div class="row g-2">
                        <div id="preventive" style="display:none;">
                            <div class="col-md-3 form-check">
                                <input type="checkbox" class="form-check-input services" name="services[troca_oleo]"
                                    value="troca_oleo" onchange="toggleServiceDetails('troca_oleo', this.checked)"> Troca de
                                Óleo
                            </div>
                            <div class="col-md-3 form-check">
                                <input type="checkbox" class="form-check-input services" name="services[troca_filtro_ar]"
                                    value="troca_filtro_ar"
                        ...
                        <div id="repair" style="display:none;">
                            ...
                            <div class="col-md-3 form-check">
                                <input type="checkbox" class="form-check-input services"
                                    name="services[reparo_transmissao]" value="reparo_transmissao"> Reparo Transmissão
                            </div>
                            <div class="col-md-3 form-check">
                                <input type="checkbox" class="form-check-input services"
                                    name="services[reparo_suspensao]" value="reparo_suspensao"> Reparo Suspensão
                            </div>
                            <div class="col-md-3 form-check">
                ...
                <div class="row g-3 mt-3">
                    ...
                    <div class="col-md-4">
                        <div class="form-floating">
                            <input type="number" name="mileageNow" class="form-control"
                                value="{{ old('mileageNow') }}" required min="0" step="0.01">
                    ...
                    <div class="col-md-12">
                        <div class="form-floating">
                            <textarea name="description" id="editor" class="form-control" style="height: 80px">{{ old('description') }}</textarea>
                    ...
                    <div class="col-md-4">
                        <div class="form-floating">
                            <input type="text" name="responsibleName" class="form-control"
                                value="{{ old('responsibleName') }}" required maxlength="100">
                            <label>Nome</label>
                        </div>
                    </div>
                    <div class="col-md-4">
