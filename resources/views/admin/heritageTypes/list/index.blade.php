...
@section('content')
    <div class="card mb-4 shadow">
        <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('heritage-types.create') }}" class="btn btn-outline-light btn-sm">
                    ...
                    @forelse($types as $t)
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{ route('heritage-types.show', $t->id) }}" class="btn btn-sm btn-info"
                                    title="Ver"><i class="fas fa-eye"></i></a>
                                <a href="{{ route('heritage-types.edit', $t->id) }}" class="btn btn-sm btn-warning"
                                    title="Editar"><i class="fas fa-pencil"></i></a>
                                <a href="#" data-url="{{ route('heritage-types.destroy', $t->id) }}"
