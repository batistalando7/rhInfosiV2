...
<div class="card mt-4 mt-4 shadow">
  <div class="card-header bg-secondary text-white d-flex justify-content-between align-items-center">
    ...
    <a href="{{ route('admin.specialties.create') }}" class="btn btn-outline-light btn-sm" title="Nova Especialidade"> Nova
      ...
      <table id="datatablesSimple" class="table table-striped table-hover">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>{{ $d->description ?? '-' }}</td>
            <td>
              <a href="{{ route('admin.specialties.show', $d->id) }}" class="btn btn-warning btn-sm" title="Visualizar">
                <i class="fas fa-eye"></i>
              </a>
              <a href="{{ route('admin.specialties.edit', $d->id) }}" class="btn btn-info btn-sm" title="Editar">
                <i class="fas fa-pencil"></i>
              </a>
              <a href="#" data-url="{{ url('admin.specialties/'.$d->id.'/delete') }}" class="btn btn-danger btn-sm delete-btn" title="Apagar">
