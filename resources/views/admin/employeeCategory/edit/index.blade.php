...
<div class="card mb-4 mt-4 shadow">
  ...
  <div class="card-body">
    <div class="row justify-content-center">
      <div class="col-md-6">
        <form method="POST" action="{{ route('admin.employeeCategories.update', $employeeCategory->id) }}">
          @csrf
          @method('PUT')

          <div class="mb-3">
            <div class="form-floating">
              <input type="text" name="name" class="form-control" id="name" placeholder="" value="{{ old('name', $employeeCategory->name) }}">
