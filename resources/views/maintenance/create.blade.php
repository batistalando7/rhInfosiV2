        ...
        <div class="card-body">
            <form action="{{ route('maintenance.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-md-6">
                        <div class="form-floating">
                            <input type="date" name="maintenanceDate" id="maintenanceDate" class="form-control"
                                placeholder="" value="{{ old('maintenanceDate') }}" required>
                    ...
                    <div class="col-md-6">
                        <div class="form-floating">
                            <input type="number" step="0.01" name="cost" id="cost" class="form-control"
                                placeholder="" value="{{ old('cost') }}" required>
                ...
                <div class="row g-3 mt-3">
                    <div class="col-md-12">
                        <div class="form-floating">
                            <textarea name="description" id="description" class="form-control" placeholder="" style="height: 80px">{{ old('description') }}</textarea>
